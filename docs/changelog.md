...
- Gestione utenti: aggiornamento profilo, username, password, privacy, posizione; controllo esistenza username; esportazione dati; eliminazione account
- Gestione libri: aggiunta, visualizzazione, ricerca (per ISBN, autore, titolo, editore, anno, lingua), upload copertine personalizzate, libri simili
- Gestione copie: aggiornamento, cancellazione, spostamento tra librerie
